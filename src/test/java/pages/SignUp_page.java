...
public class SignUp_page extends CapScreenMethods
{
//Constructor
//===================================================================||
   public SignUp_page(AppiumDriver<WebElement> driver)
   {
...
//Methods
//===================================================================||
public void checkVerticalBar()
{
    boolean label = VERTICAL_BAR_1.isDisplayed();
    try
    {
        if(label = true)
        {
...
//---------------------------------------------------------------------||
public String registrationIsValid(String name)
{
    String registration_text = REGISTER_NAME.getText();

    if(REGISTER_NAME.isDisplayed())
    {
        if(registration_text.equals(name))
        {
            System.out.println("SING UP SUCCESS --- OK");
        }
        else
        {
            System.out.println("SIGN UP text ERROR !!!");
        }
    }
    return name;
}
