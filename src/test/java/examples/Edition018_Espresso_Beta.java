...
public class Edition018_Espresso_Beta {
    ...
    private AndroidDriver getDriver(String automationName) throws MalformedURLException
    {
        ...
        capabilities.setCapability("deviceName", "Samsung 6s");
...
//C:\Users\liesn>adb shell
//zeroflte:/ $ dumpsys window windows | grep -E 'mCurrentFocus'
//  mCurrentFocus=Window{c139c43d0 u0 io.cloudgrey.the_app/com.reactnativenavigation.controllers.NavigationActivity}